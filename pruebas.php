...
<br>
    <div class="row">
        <button  id="alerta" onclick="cambio()"> Sweet <i class="fas fa-user"></i></button>
        ...
        $.ajax({
            ...
            success:function (data) {
                ...
                $.each(data, function (indexInArray, value) { 
                    $("#elselec").append('<option value='+value.id_producto+'>'+value.nombre+'</option>');
